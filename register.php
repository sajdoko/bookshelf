          ...
          <div class="row">
            <div class="col-lg-12">
              <form id="register-form" method="post" role="form" style="display: block;">
                ...
                <div class="form-group">
                  <input type="text" name="first-name" id="first-name" tabindex="4" class="form-control" placeholder="First Name" value="">
                </div>
                <div class="form-group">
                  <input type="text" name="last-name" id="last-name" tabindex="5" class="form-control" placeholder="Last Name" value="">
                </div>
                <div class="form-group">
