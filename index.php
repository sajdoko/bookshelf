        ...
        <div class='col-sm-12 col-md-6'>
            ...
            <div class='row shadow'>
                <div class='col p-4'>
                    ...
                    <h3 class='card-title mb-0' style='min-height: 50px;'><?php echo $book['Boo_Title']; ?></h3>
                ...
                <div class='col-auto px-0'>
                    <img src="<?php echo $book['Boo_Img_url']; ?>" height="350" class='bd-placeholder-img card-img-top' alt='Book cover'>
                </div>
            </div>
            </div>
        </div>
    ...
    <?php foreach (get_featured_books() as $book): ?>
      ...
      <div class="col-sm-12 col-md-4">
          <div class="card shadow-sm">
              <img src="<?php echo $book['Boo_Img_url']; ?>" class="bd-placeholder-img card-img-top" alt="Book cover">
              <div class="card-body">
