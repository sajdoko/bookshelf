...
VALUES (NEXT VALUE FOR SEQ_PUB_ID, 'Penguin Random House', '212-366-2000'),
       (NEXT VALUE FOR SEQ_PUB_ID, 'Hatchet Book Group', '212-364-1100'),
       ...
       (NEXT VALUE FOR SEQ_PUB_ID, 'Rutledge', '212-216-7800'),
...
VALUES (NEXT VALUE FOR SEQ_GEN_ID, 'Mystery'),
       ...
       (NEXT VALUE FOR SEQ_GEN_ID, 'Historical Fiction'),
       (NEXT VALUE FOR SEQ_GEN_ID, 'Crime'),
       (NEXT VALUE FOR SEQ_GEN_ID, 'Western'),
       (NEXT VALUE FOR SEQ_GEN_ID, 'Non-Fiction'),
...
VALUES (NEXT VALUE FOR SEQ_AUT_ID, 'J.K. Rowling', 'British author and philanthropist'),
       ...
       (NEXT VALUE FOR SEQ_AUT_ID, 'Jane Auguste', 'English novelist known primarily for her six major novels'),
       (NEXT VALUE FOR SEQ_AUT_ID, 'Mark Twain', 'American writer and humorist'),
       ...
       (NEXT VALUE FOR SEQ_AUT_ID, 'J.R.R. Tolkien', 'English writer, poet, philologist, and academic'),
       ...
       (NEXT VALUE FOR SEQ_AUT_ID, 'Michael Crichton',
       ...
       (NEXT VALUE FOR SEQ_AUT_ID, 'Neil Gaiman',
        'English author of short fiction, novels, comic books, graphic novels, audio theatre, and films'),
       (NEXT VALUE FOR SEQ_AUT_ID, 'David Baldacci', 'American author of novels for adults and children');
...
INSERT INTO EMPLOYEE (Emp_Id, Emp_Type, Emp_FirstName, Emp_LastName, Emp_Email, Emp_Pass, Emp_Phone)
VALUES (NEXT VALUE FOR SEQ_EMP_ID, 'Manager', 'Joh', 'Doe', 'johndoe@email.com',
        '$2y$10$uXf5m9MudTFbsLt3lOVpR.XkmMIsoJfA8S/cJG71HFX81quLHNGdW', '555-555-1212'),
    (NEXT VALUE FOR SEQ_EMP_ID, 'Sales_Person', 'Jane', 'Doe', 'janedoe@email.com',
        '$2y$10$uXf5m9MudTFbsLt3lOVpR.XkmMIsoJfA8S/cJG71HFX81quLHNGdW', '555-555-2323');

INSERT INTO MANAGER (Emp_Id, Department)
VALUES (1, 'Sales');

INSERT INTO SALES_PERSON (Emp_Id, Sls_Commission)
VALUES (2, 0.05);
...
VALUES (NEXT VALUE FOR SEQ_CUS_ID, 'Joh', 'Doe', 'johndoe@email.com',
        '$2y$10$uXf5m9MudTFbsLt3lOVpR.XkmMIsoJfA8S/cJG71HFX81quLHNGdW', '555-555-5555', '2022-12-01 12:00:00'),
       (NEXT VALUE FOR SEQ_CUS_ID, 'Jane', 'Doe', 'janedoe@email.com',
        '$2y$10$uXf5m9MudTFbsLt3lOVpR.XkmMIsoJfA8S/cJG71HFX81quLHNGdW', '555-555-5556', '2022-11-01 12:00:00'),
       (NEXT VALUE FOR SEQ_CUS_ID, 'Jim', 'Smith', 'jimsmith@email.com',
        '$2y$10$uXf5m9MudTFbsLt3lOVpR.XkmMIsoJfA8S/cJG71HFX81quLHNGdW', '555-555-5557', '2022-11-01 12:00:00');
...
VALUES ('978-0439136358', 6, 1, 'Harry Potter and the Prisoner of Azkaban',
